...
{
public:
    AssetInterface(const std::string& loadingPath, AssetId assetId, const std::function<void(AssetId)>& updateResourceInUICallback,
    ...
    std::string computeIconPath() const;
...
protected:
    ...
    std::function<void(AssetId)> m_updateAssetInUICallback;
