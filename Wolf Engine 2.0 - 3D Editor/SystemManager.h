...
private:
	...
	void changeScale(const ultralight::JSObject& thisObject, const ultralight::JSArgs& args) const;
	...
	void changeBuildingSize(const ultralight::JSObject& thisObject, const ultralight::JSArgs& args) const;
